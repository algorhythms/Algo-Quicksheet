...
\runinhead{Partial Quicksort}  Then the $A[:k]$ is sorted $k$ smallest. The algorithm recursively sort the $A[i:j]$
...
\runinhead{Find $k$-th in union of two sorted array.} TODO
\subsection{Applications}
\runinhead{Wiggle Sort.} TODO
\section{Inversion}
